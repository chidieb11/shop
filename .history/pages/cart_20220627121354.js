        ...
        <div className="grid md:grid-cols-4 md:gap-5">
          ...
          <div>
            <ul>
                <li>
                    <div>
                        Subtotal({cartItems.reduce((accumulator, currentValue) => accumulator + currentValue.price, 0)}):${cartItems.reduce((accumulator, currentValue) => accumulator + currentValue.price, 0)}})})
                    </div>
                </li>
            </ul>
          </div>
